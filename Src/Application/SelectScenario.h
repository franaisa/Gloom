...
#ifndef __Application_SelectScenario_H
...
namespace Application 
{
	...
	@date Agosto, 2010
	*/
	class CSelectScenario : public CApplicationState 
	{
	public:
		/** 
		Constructor de la clase 
		*/
		CSelectScenario(CBaseApplication *app) : CApplicationState(app)
		{}
