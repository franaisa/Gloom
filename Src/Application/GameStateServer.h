...
namespace Application 
{
	...
	@date Agosto, 2010
	*/
	class CGameStateServer : public CApplicationState, public Net::CManager::IObserver
	{
	public:
		/** 
		Constructor de la clase 
		*/
		CGameStateServer(CBaseApplication *app) : CApplicationState(app), 
				_scene(0), _time(0) {}

		/** 
		Destructor 
		*/
		virtual ~CGameStateServer() {}
