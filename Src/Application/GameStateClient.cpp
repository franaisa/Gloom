...
namespace Application {
	...
	void CGameStateClient::activate() {
	...
	void CGameStateClient::deactivate() {
	...
	bool CGameStateClient::keyPressed(GUI::TKey key) {
		return false;
	...
	bool CGameStateClient::keyReleased(GUI::TKey key) {
		switch(key.keyId) {
		case GUI::Key::ESCAPE:
			_app->setState("menu");
	...
	bool CGameStateClient::mouseMoved(const GUI::CMouseState &mouseState) {
		return false;
	...
	bool CGameStateClient::mousePressed(const GUI::CMouseState &mouseState) {
		return false;
	...
	bool CGameStateClient::mouseReleased(const GUI::CMouseState &mouseState) {
		return false;
