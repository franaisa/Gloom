...
#ifndef __Logic_CoolDownClient_H
#define __Logic_CoolDownClient_H
...
namespace Logic {
	...
	*/
	...
	class CCoolDownClient : public ISpell {
		DEC_FACTORY(CCoolDownClient);

	public:

		/** Constructor por defecto. */
		CCoolDownClient() : ISpell("coolDown") { }

		//__________________________________________________________________

		virtual ~CCoolDownClient();
		...
		leida del mapa:
		<ul>
			<li><strong>spellCoolDownClientDamageReflect:</strong> Daño que hace el coolDown al golpear contra el mundo. </li>
		</ul>
