//---------------------------------------------------------------------------
// AmplifyDamageClient.h
//---------------------------------------------------------------------------

/**
@file AmplifyDamageClient.h
...
#ifndef __Logic_AmplifyDamageClient_H
#define __Logic_AmplifyDamageClient_H
...
namespace Logic {
	...
	*/
	...
	class CAmplifyDamageClient : public ISpell {
		DEC_FACTORY(CAmplifyDamageClient);

	public:

		/** Constructor por defecto. */
		CAmplifyDamageClient() : ISpell("amplifyDamage"), _newPercentDamage(0) { }

		//__________________________________________________________________

		virtual ~CAmplifyDamageClient();
	...
	}; // class CAmplifyDamageClient

	REG_FACTORY(CAmplifyDamageClient);
