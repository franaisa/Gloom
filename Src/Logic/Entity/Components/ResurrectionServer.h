...
#ifndef __Logic_ResurrectionServer_H
#define __Logic_ResurrectionServer_H
...
namespace Logic {
	...
	*/
	...
	class CResurrectionServer : public ISpell {
		DEC_FACTORY(CResurrectionServer);

	public:

		/** Constructor por defecto. */
		CResurrectionServer() : ISpell("resurrection") { }

		//__________________________________________________________________

		virtual ~CResurrectionServer();
	...
	REG_FACTORY(CResurrectionServer);
