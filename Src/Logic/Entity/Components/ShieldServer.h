...
#ifndef __Logic_ShieldServer_H
#define __Logic_ShieldServer_H
...
namespace Logic {
	...
	*/
	...
	class CShieldServer : public ISpell {
		DEC_FACTORY(CShieldServer);

	public:

		/** Constructor por defecto. */
		CShieldServer() : ISpell("shield"),_shieldSpell(0) { }

		//__________________________________________________________________

		virtual ~CShieldServer();
