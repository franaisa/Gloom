...
#ifndef __Logic_Resurrection_H
#define __Logic_Resurrection_H
...
namespace Logic {
	...
	*/
	...
	class CResurrection : public ISpell {
		DEC_FACTORY(CResurrection);
