//---------------------------------------------------------------------------
// AmplifyDamageServer.h
//---------------------------------------------------------------------------

/**
@file AmplifyDamageServer.h
...
#ifndef __Logic_AmplifyDamageServer_H
#define __Logic_AmplifyDamageServer_H
...
namespace Logic {
	...
	*/
	...
	class CAmplifyDamageServer : public ISpell {
		DEC_FACTORY(CAmplifyDamageServer);

	public:

		/** Constructor por defecto. */
		CAmplifyDamageServer() : ISpell("AmplifyDamage"), _newPercentDamage(0) { }

		//__________________________________________________________________

		virtual ~CAmplifyDamageServer();
	...
	}; // class CAmplifyDamageServer

	REG_FACTORY(CAmplifyDamageServer);
