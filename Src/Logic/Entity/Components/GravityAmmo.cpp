...
namespace Logic {
	...
	IMP_FACTORY(CGravityAmmo);

	//__________________________________________________________________

	CGravityAmmo::CGravityAmmo() : ISpellAmmo("gravity"),
								_defaultCooldown(0),
								_cooldown(0),
								_duration(0),
								_maxAmmo(0),
