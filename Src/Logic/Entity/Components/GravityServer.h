...
#ifndef __Logic_GravityServer_H
#define __Logic_GravityServer_H
...
namespace Logic {
	...
	*/
	...
	class CGravityServer : public ISpell {
		DEC_FACTORY(CGravityServer);

	public:

		/** Constructor por defecto. */
		CGravityServer() : ISpell("gravity") { }

		//__________________________________________________________________

		virtual ~CGravityServer();
		...
		leida del mapa:
		<ul>
			<li><strong>spellGravityServerDamageReflect:</strong> Daño que hace el gravity al golpear contra el mundo. </li>
		</ul>
