...
#ifndef __Logic_ComeBackServer_H
#define __Logic_ComeBackServer_H
...
namespace Logic {
	...
	*/
	...
	class CComeBackServer : public ISpell {
		DEC_FACTORY(CComeBackServer);

	public:

		/** Constructor por defecto. */
		CComeBackServer() : ISpell("comeBack"), _ComeBackServerPosition(Vector3::ZERO), _ComeBackServerOrientation(Quaternion::ZERO) { }

		//__________________________________________________________________

		virtual ~CComeBackServer();
	...
	private:
		...
		Vector3 _ComeBackServerPosition;
		Quaternion _ComeBackServerOrientation;
	}; // class CShootRaycast

	REG_FACTORY(CComeBackServer);
