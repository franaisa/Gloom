...
namespace Logic {
	IMP_FACTORY(CHardDeathServer);

	CHardDeathServer::~CHardDeathServer() {
		// Nada que hacer
	}

	//__________________________________________________________________
	
	bool CHardDeathServer::spawn(CEntity* entity, CMap *map, const Map::CEntity *entityInfo) {
	...
	void CHardDeathServer::spell(){ 
			createExplotion();
	} // spell
	//__________________________________________________________________
		
	void CHardDeathServer::stopSpell() {

	} // stopSpell
	//__________________________________________________________________

	void CHardDeathServer::createExplotion() {
	...
	void CHardDeathServer::estimateDamage(CEntity* entityHit, const Vector3& explotionPos) {
