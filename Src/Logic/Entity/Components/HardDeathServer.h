...
#ifndef __Logic_HardDeathServer_H
#define __Logic_HardDeathServer_H
...
namespace Logic {
	...
	Este componente implementa la funcionalidad del HardDeathServer. 

	@author Jaime Chapinal Cervantes
	@date Junio, 2013
	*/

	class CHardDeathServer : public ISpell {
		DEC_FACTORY(CHardDeathServer);

	public:

		/** Constructor por defecto. */
		CHardDeathServer() : ISpell("hardDeath"),	_heightShoot(0),
											_damage(0),
											_explotionRadius(0){ }

		//__________________________________________________________________

		virtual ~CHardDeathServer();
